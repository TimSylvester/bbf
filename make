...
$CC -c -std=c++11 $WARN $OPT $DBG -o .obj/Sha2Generator.o src/Sha2Generator.cpp && \
$CC $WARN $DBG $OPT -o bin/Sha2Generator .obj/Sha2Generator.o $LIBS && \
$CC -c -std=c++11 $WARN $OPT $DBG -o .obj/RandSecretGenerator.o src/RandSecretGenerator.cpp && \
$CC $WARN $DBG $OPT -o bin/RandSecretGenerator .obj/RandSecretGenerator.o $LIBS && \
$CC -c -std=c++11 $WARN $OPT $DBG -I../bloom -DBC_STATIC -o .obj/bbf.o src/bbf.cpp && \
